...
public class DbConsumerBattery {

    public static void main(String[] args) {

        Table table = getTable("/apps/anki_baterry");


        KafkaConsumer<String, String> consumer;
        Properties properties = new Properties();
        properties.setProperty("group","anki_db_consumer_data_battery");
        ...
        Pattern pattern = Pattern.compile("/apps/anki:iot-battery.*");
