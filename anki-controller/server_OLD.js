...
var ankiNodeUtils = require('./ankiNodeUtils_js_new.js')();
 ...
 *     curl -i http://127.0.0.1:7877/connect/Guardian

 * @apiSampleRequest http://127.0.0.1:7877/connect/:carname
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/disconnect/Guardian
 *
 * @apiSampleRequest http://127.0.0.1:7877/disconnect/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/setSpeed/Guardian/600
 *
 * @apiSampleRequest http://127.0.0.1:7877/setSpeed/:carname/:speed
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/changeLanes/Skull/24
 *
 * @apiSampleRequest http://127.0.0.1:7877/changeLanes/:carname/changeValue
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/setLaneOffset/Ground%20Shock/68
 *
 * @apiSampleRequest http://127.0.0.1:7877/setLaneOffset/:carname/:changeValue
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/turnOnHeadlights/Nuke
 *
 * @apiSampleRequest http://127.0.0.1:7877/turnOnHeadlights/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/turnOffHeadlights/Nuke
 *
 * @apiSampleRequest http://127.0.0.1:7877/turnOffHeadlights/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/turnOnTaillights/Guardian
 *
 * @apiSampleRequest http://127.0.0.1:7877/turnOnTaillights/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/flashTaillights/Thermo
 *
 * @apiSampleRequest http://127.0.0.1:7877/flashTaillights/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/turnOffTaillights/Thermo
 *
 * @apiSampleRequest http://127.0.0.1:7877/turnOffTaillights/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/setEngineLight/Skull/15/0/15
 *
 * @apiSampleRequest http://127.0.0.1:7877/setEngineLight/:carname/:red/:green/:blue
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/ping/Skull
 *
 * @apiSampleRequest http://127.0.0.1:7877/ping/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "ping": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/batteryLevel/Skull
 *
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/getDevices
 *
 * @apiSampleRequest http://127.0.0.1:7877/getDevices
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {"carList":
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/rescan
 *
 * @apiSampleRequest http://127.0.0.1:7877/rescan
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877/turnOnLogging/Skull
 *
 * @apiSampleRequest http://127.0.0.1:7877/turnOnLogging/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://127.0.0.1:7877//trackCountTravel/Skull/15/800
 *
 * @apiSampleRequest http://127.0.0.1:7877/trackCountTravel/:carname/:trackCount/:speed
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i -X POST http://127.0.0.1:7877/mapTrack/Skull
 *
 * @apiSampleRequest http://127.0.0.1:7877/mapTrack/:carname
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 *   UTF8 - image/png
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i -X POST http://127.0.0.1:7877/mapSave
 *
 * @apiSampleRequest http://127.0.0.1:7877/mapSave
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 *   UTF8 - image/png
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i -X POST http://127.0.0.1:7877/mapLoad
 *
 * @apiSampleRequest http://127.0.0.1:7877/mapLoad
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 *   UTF8 - image/png
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i -X GET http://127.0.0.1:7877/getTrackMapData
 *
 * @apiSampleRequest http://127.0.0.1:7877/getTrackData
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "map": "[[0,0],[1,2],[3,2],[5,6]]"
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i -X GET http://127.0.0.1:7877/getTrackMap/medium
 *
 * @apiSampleRequest http://127.0.0.1:7877/getTrackMap/:size
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * {
 *   "result": "Success"
...
var server = app.listen(7877, function() {
    console.log("Example app listening at http://localhost:7877");
    var host = "localhost";
    var port = "7877";
